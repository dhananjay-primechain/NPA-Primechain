...
// function publishFormData(params) {
//   var formData = params.formData;
//   var streamName = params.stream;
//   var key = params.key;
//   var file_stream_name = params.file_stream_name;
//   var data_stream_name = params.data_stream_name;
...
//           data: Buffer.from(files[_key].data).toString('hex')
//         };
...
//         let file_data = crypto.createHash('sha256').update(file_info).digest('hex');

//         // publish file data to blockchain
//         publishFrom(file_stream_name, file_hash, file_data, address, (err, result) => {
...
//       // convert the json object to hexadecimal
//       let data = str2hex(JSON.stringify(json));
//       (form_data);
